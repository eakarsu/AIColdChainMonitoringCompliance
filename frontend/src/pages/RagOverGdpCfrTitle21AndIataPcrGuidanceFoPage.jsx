...
export default function RagOverGdpCfrTitle21AndIataPcrGuidanceFoPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const r = await fetch('/api/cf-rag-over-gdp-cfr-title-21-and-iata-pcr-guidance-fo/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb', maxWidth: 980 }}>
      <h2 style={{ marginTop: 0 }}>RAG over GDP, CFR Title 21, and IATA PCR guidance for compliance Q&A</h2>
      <p style={{ color: '#9ca3af', fontSize: 13 }}>
        Endpoint: <code>/api/cf-rag-over-gdp-cfr-title-21-and-iata-pcr-guidance-fo/run</code>. Submit context as text; the backend calls OpenRouter and returns structured JSON.
      </p>
