...
export default function WhiteLabelDeploymentFor3plsAndPharmaDistribPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const r = await fetch('/api/cf-white-label-deployment-for-3pls-and-pharma-distrib/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb', maxWidth: 980 }}>
      <h2 style={{ marginTop: 0 }}>White-label deployment for 3PLs and pharma distributors</h2>
      <p style={{ color: '#9ca3af', fontSize: 13 }}>
        Endpoint: <code>/api/cf-white-label-deployment-for-3pls-and-pharma-distrib/run</code>. Submit context as text; the backend calls OpenRouter and returns structured JSON.
      </p>
